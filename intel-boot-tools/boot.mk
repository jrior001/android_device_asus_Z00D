...
# CMDLINE_NEW := path/to/cmdline.txt
...
CMDLINE_NEW := device/asus/Z00D/intel-boot-tools/cmdline_new

$(INSTALLED_RECOVERYIMAGE_TARGET): $(recovery_ramdisk) \
		$(recovery_kernel) \
		$(INTEL_PACK)
	$(call pretty,"Target recovery image: $@")
	$(INTEL_PACK) $(BASE_RECOVERY_IMAGE) $(recovery_kernel) $(recovery_ramdisk) $(CMDLINE_NEW) $@
...
$(INSTALLED_BOOTIMAGE_TARGET): $(INSTALLED_RAMDISK_TARGET) \
	...
	$(INTEL_PACK) $(BASE_BOOT_IMAGE) $(INSTALLED_KERNEL_TARGET) $(INSTALLED_RAMDISK_TARGET) $(CMDLINE_NEW) $@
